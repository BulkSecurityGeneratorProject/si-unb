...
export class FarmaciaComponent implements OnInit, OnDestroy {
  ...
  loadAll() {
    this.farmaciaService
      ...
      .subscribe(
        (res: HttpResponse<IFarmacia[]>) => this.paginateFarmacias(res.body, res.headers),
  ...
  trackId(index: number, item: IFarmacia) {
    return item.id;
  }
  ...
  protected paginateFarmacias(data: IFarmacia[], headers: HttpHeaders) {
